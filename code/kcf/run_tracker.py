...
def format_outline(pos,target_size):
    ...
    out_str = '{},{},{},{}'.format(result_pos[0],result_pos[1],result_pos[2],result_pos[3])
    out_str += '\n'
    return out_str
...
def main(args):
    ...
    for video in video_list:
        if video == 'Bird1' or video == 'Car1' or video == 'Car4' or video == 'Car2' or video == 'Car24' \
                or video == 'FaceOcc2' or video == 'FaceOcc1'or video == 'David3' or video == 'Girl' \
                or video == 'Girl2' or video == 'Human3' or video == 'Human4' or video == 'Human4-2'\
                or video == 'Subway':
            continue
        dataset_path = os.path.join(video_path, '{}'.format('Basketball'))
        ...
        if save_result:
            result_file = os.path.join('/home/caoyu/1/result/',"{}.txt".format(video))
...
def parse_argument(argv):
    ...
    parser.add_argument('--save_result', type=bool,help="save result or not",default=True)
